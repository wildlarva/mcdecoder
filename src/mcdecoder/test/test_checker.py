...
def test__check_no_mask() -> None:
    ...
    assert len(
        list(_check('test/arm.yaml', '1110 1001 0010 1101 0100 1000 0000 0000', 2))) == 0
...
def test__check_one_character_mask() -> None:
    ...
    assert len(
        list(_check('test/arm.yaml', 'x110 1001 0010 1101 0100 1000 0000 0000', 2))) == 0
    ...
    assert len(
        list(_check('test/arm.yaml', '111x 1001 0010 1101 0100 1000 0000 000x', 2))) == 1

    # Last letter
    assert len(list(_check('test/arm.yaml', 'e9 2d 48 0x', 16))) == 0

    assert len(
        list(_check('test/arm.yaml', '1110 1001 0010 1101 0100 1000 0000 000x', 2))) == 0
...
def test__check_sequential_mask() -> None:
    ...
    assert len(
        list(_check('test/arm.yaml', '111x x001 0010 1101 0100 1000 0000 000x', 2))) == 2
...
def test__check_split_mask() -> None:
    ...
    assert len(
        list(_check('test/arm.yaml', '111x 100x 0010 1101 0100 1000 0000 000x', 2))) == 2
